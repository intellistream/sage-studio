---
name: sage-studio
description: 'SAGE Studio engineering agent for frontend/backend changes, CLI startup flow, testing, and docs alignment.'
argument-hint: "Describe the Studio task, affected area (frontend/backend/CLI), constraints, and expected validation commands."
